...
void image::checkIfAvailable(void) 
{
...
#ifdef _DEBUG
		cout << "Image file loaded, generating texture data" << endl;
#endif
 ...
 #ifdef _DEBUG
		cout << "pointer created successfully now building signature" << endl;
#endif
...
#ifdef _DEBUG
		cout << "Signature loaded successfully now building texture" << endl;
#endif
	png_read_png(png_ptr, info_ptr, PNG_TRANSFORM_STRIP_16 | PNG_TRANSFORM_PACKING | PNG_TRANSFORM_EXPAND, NULL);
#ifdef _DEBUG
		cout << "Texture built successfully" << endl;
#endif
